...
let TableClient = function (tableId, httpClient) {
    if (this instanceof TableClient) {
        if (typeof tableId !== "number") throw new Error("tableId must be a number")
        this.tableId = tableId;
        this.httpClient = httpClient;

        this.endpoint = `https://${initConfig.storyclmType}api.storyclm.com/v1/tables/${this.tableId}`;
        // this.endpoint = "https://staging-api.storyclm.com/v1/tables/" + this.tableId;
    } else {
